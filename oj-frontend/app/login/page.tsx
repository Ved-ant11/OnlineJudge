  ...
  return (
    <div className="flex min-h-[calc(100vh-3rem)] flex-col items-center justify-center">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4 w-full max-w-sm mt-6">
        ...
        <p className="shrink-0 text-xs text-neutral-400 px-1">Don&apos;t have an account?</p>
        <Link href="/signup" className="text-sm text-neutral-400 hover:text-neutral-200 transition-colors gap-6">
          Sign Up
        </Link>
      </form>
    </div>
